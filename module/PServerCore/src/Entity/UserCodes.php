 ...
 * @ORM\Entity(repositoryClass="PServerCore\Entity\Repository\UserCodes")
 */
class UserCodes
{
    ...
    const TYPE_CHANGE_EMAIL_STEP_1 = 'change_email_step1';
    const TYPE_CHANGE_EMAIL_STEP_2 = 'change_email_step2';
