...
class InventoryForAvatar extends EntityRepository
{
    /**
     * @param $characterId
     *
     * @return \GameBackend\Entity\SRO\Shard\InventoryForAvatar[]
     */
    public function getInventorySet4CharacterId($characterId): array
    {
     ...
     * @param $characterId
     * @param $slot
     * @return \GameBackend\Entity\SRO\Shard\InventoryForAvatar|null
     * @throws \Doctrine\ORM\NonUniqueResultException
     */
    public function getInventorySlot($characterId, int $slot)
    {
        $query = $this->createQueryBuilder('p')
            ->select('p')
            ->where('p.char = :char')
