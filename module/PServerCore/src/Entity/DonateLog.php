 ...
 * @ORM\Entity(repositoryClass="PServerCore\Entity\Repository\DonateLog")
 */
class DonateLog
{
    ...
    const TYPE_PAYSSION = 'payssion';
    const TYPE_PAYOP = 'payop';
    const TYPE_MAXIGAME = 'maxigame';
    const TYPE_HIPOPOTAMYA = 'hipopotamya';
    const TYPE_TIKLA_ODE = 'tikla_ode';
    const TYPE_INTERNAL = 'internal';
    const TYPE_UNIT_PAY = 'unitpay';
    const TYPE_PAYWANT = 'paywant';
    const TYPE_CENT_APP = 'centapp';
