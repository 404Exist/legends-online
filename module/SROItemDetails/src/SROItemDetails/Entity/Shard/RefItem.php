...
use GameBackend\Entity\SRO\Shard\RefObjItem;
...
class RefItem implements RefItemInterface
{
     ...
     * @var string
     *
     * @ORM\Column(name="webName", type="string", nullable=false)
     */
    private $webName;
     ...
     * @var RefObjItem
     *
     * @ORM\OneToOne(targetEntity="GameBackend\Entity\SRO\Shard\RefObjItem", fetch="EXTRA_LAZY")
