...
class User implements UserInterface
{
    ...
    /**
     * @var string
     * @ORM\Column(name="know_about", type="string", length=45, nullable=false)
     */
    private $knowAbout = '';
     ...
     * @return string
     */
    public function getKnowAbout(): string
    {
        return $this->knowAbout;
    }

    /**
     * @param string $knowAbout
     * @return $this
     */
    public function setKnowAbout(string $knowAbout)
    {
